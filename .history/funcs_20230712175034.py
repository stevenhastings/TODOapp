...
def perform_action(user_action):
    if user_action == "add":
    ...
    elif user_action in ["remove", "delete", "del"]:
        todos = read_todos()
    ...
    elif user_action == "delete all todos":
    ...
    elif user_action in ["edit", "change"]:
        todos = read_todos()
        print("Here are your todos:")
        for index, todo in enumerate(todos):
            print(f"{index + 1}. {todo.strip()}")
    ...
    elif user_action in ["complete", "done"]:
